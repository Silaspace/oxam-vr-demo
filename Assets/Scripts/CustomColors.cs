...
public class CustomColors : MonoBehaviour
{
    ...
    private readonly static double[,] inferno_data = {{0.001462, 0.000466, 0.013866},
    ...
    private readonly static double[,] plasma_data = {{0.050383, 0.029803, 0.527975},
    ...
    private readonly static double[,] viridis_data = {{0.267004, 0.004874, 0.329415},
